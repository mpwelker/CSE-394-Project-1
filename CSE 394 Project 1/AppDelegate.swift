...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        Parse.setApplicationId("6qfpuwn8iQPubB1hq6fbbQzvR9IWxthTUVeAUqBl",
            clientKey: "PCSX8dik3wPonhQStrqyxFGC7af5qxTTLmCtGCKQ")
        //PFAnalytics.trackAppOpenedWithLaunchOptionsInBackground(launchOptions)

        // Pause for splashscreen (cheap hack, I know...)
        sleep(1)
